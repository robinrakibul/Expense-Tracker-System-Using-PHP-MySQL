...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update usertable set Password='$password'  where  Email='$email' && MobileNumber='$contactno' ");
   if($query)
   {
...
<head>
	...
	<title>Expense Tracker System - Forgot Reset</title>
    ...
    echo $msg;
					...
					<form role="form" action="" method="post" name="changepassword" onsubmit="return checkpass()">
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="" name="submit" class="btn btn-primary">Reset</button><span style="padding-left:250px"><a href="index.html" class="btn btn-primary">Login</a></span>
