...
$query=mysqli_query($con,"select ID from usertable where ID='$userid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update usertable set Password='$newpassword' where ID='$userid'");
...
<head>
	...
	<title>Expense Tracker System || Change Password</title>
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php
$userid=$_SESSION['u_id'];
$ret=mysqli_query($con,"select * from usertable where ID='$userid'");
$cnt=1;
