...
<head>
	...
	<title>Expense Tracker System | Yearwise Expense Report</title>
...
$ret=mysqli_query($con,"SELECT year(ExpenseDate) as rptyear,SUM(ExpenseCost) as totalyear FROM maintable  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by year(ExpenseDate)");
$cnt=1;
